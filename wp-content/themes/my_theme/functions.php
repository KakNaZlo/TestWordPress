...
function my_theme_scripts() {
	...
	wp_style_add_data( 'my_theme-style', get_stylesheet_uri(), '/style.css' );

	wp_enqueue_script( 'my_theme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'my_theme-script', get_template_directory_uri() . '/js/js.js'); 
...
remove_filter( 'the_excert', 'wpautop');
...
add_action('init', function(){
	register_post_type( 'logo', array(
		'lables' => array(
			'name' => 'Лого партнёров',
			 'singular_name'      => 'partners_logo',
			'add_new'            => 'Добавить новый',
			'add_new_item'       => 'Добавить новый логотип',
			'edit_item'          => 'Редактировать логотип',
			'new_item'           => 'Новый логотип',
			'view_item'          => 'Посмотреть логотип',
			'search_items'       => 'Найти кнлоготипигу',
			'not_found'          => 'логотип не найдено',
			'not_found_in_trash' => 'В корзине логотип не найдено',
			'parent_item_colon'  => '',
			'menu_name'          => 'логотип'
		),
		'publick'  => 'true',
